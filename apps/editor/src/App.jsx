...
export default function App() {
  ...
  const trimmedDuration = useMemo(() => Math.max(0, trimEnd - trimStart), [trimStart, trimEnd]);
  ...
  const canRender = videoFile && !busy && (videoDuration === 0 || trimmedDuration > 0);
  ...
  return (
    <div className="app">
      <header className="hero">
        <h1>
          🎬 Comenta <span>Editor</span>
        </h1>
        <p>
          Edite vídeo e música que vieram de apps externos — como
          <strong> CapCut</strong> e <strong>Suno</strong> — direto no navegador. Nada é enviado
          para servidores: tudo acontece no seu computador.
        </p>
      </header>
      ...
      <main className="grid">
        <section className="panel">
          ...
          <label className="drop">
            ...
            <div className="drop-inner">
              ...
              {videoDuration > 0 && <small>Duração: {secondsToLabel(videoDuration)}</small>}
            </div>
          </label>
          ...
          <label className="drop">
            ...
            <div className="drop-inner">
              ...
              {audioDuration > 0 && <small>Duração: {secondsToLabel(audioDuration)}</small>}
            </div>
          </label>
        ...
        <section className="panel">
          ...
          {resultUrl ? (
            ...
            <p className="hint">
              O resultado aparece aqui depois de gerar o vídeo. Você poderá assistir e baixar em
              MP4.
            </p>
          )}
      ...
      <footer className="foot">
        <p>
          Processamento local com FFmpeg (WebAssembly). Importe seus próprios arquivos exportados
          dos apps — respeite os direitos autorais das músicas e vídeos que usar.
        </p>
      </footer>
    </div>
  );
