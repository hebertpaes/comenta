...
echo "⚡ 3/5 Configurando servidor Node.js Comenta AI..."
...
<head>
  ...
  <title>Comenta AI — Atendimento & Automação de WhatsApp</title>
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet" />
  <style>
    * { box-sizing: border-box; font-family: 'Inter', sans-serif; }
    body { margin: 0; background: #0b0f19; color: #f8fafc; min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; p-6; }
    .card { background: #141a29; border: 1px solid #1e293b; border-radius: 24px; max-width: 600px; width: 100%; padding: 40px; text-align: center; box-shadow: 0 20px 50px rgba(0,0,0,0.5); }
...
<body>
  <div class="card">
    <div class="badge">✦ Oracle Cloud Live • sa-saopaulo-1</div>
    <h1>Comenta AI 2.0</h1>
    <p>Plataforma de Atendimento com Inteligência Artificial, Qualificação de Leads no WhatsApp e Gestão de Vendas.</p>
    <a href="https://comenta.com.br" class="btn">Acessar Plataforma comenta.com.br</a>
  </div>
</body>
</html>`);
});
...
server.listen(PORT, "0.0.0.0", () => {
  console.log(`🚀 Comenta AI Server rodando na porta ${PORT}`);
});
EOF

cd /var/www/comenta
pm2 delete all 2>/dev/null || true
pm2 start server.js --name comenta
pm2 save

# 4. Configurar Nginx para comenta.com.br
echo "🌐 4/5 Configurando Nginx Reverse Proxy..."
sudo cat << 'EOF' > /etc/nginx/sites-available/comenta.com.br
server {
    listen 80 default_server;
    listen [::]:80 default_server;
    server_name comenta.com.br www.comenta.com.br 147.15.103.114 _;
...
sudo ln -sf /etc/nginx/sites-available/comenta.com.br /etc/nginx/sites-enabled/
sudo rm -f /etc/nginx/sites-enabled/default
sudo nginx -t && sudo systemctl reload nginx

# 5. Certbot SSL
echo "🔒 5/5 Configurando Certificados SSL..."
sudo certbot --nginx -d comenta.com.br -d www.comenta.com.br --non-interactive --agree-tos -m contato@comenta.com.br || sudo systemctl reload nginx

echo "=========================================================================="
echo "🎉 IMPLANTAÇÃO NA ORACLE CLOUD CONCLUÍDA COM SUCESSO!"
echo "🌐 Website: https://comenta.com.br"
echo "=========================================================================="
