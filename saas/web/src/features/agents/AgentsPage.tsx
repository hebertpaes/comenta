...
const AGENTES: Agent[] = [
  {
    ...
    descricao:
      "Agente principal de IA com capacidades avançadas em texto, raciocínio comercial, imagens e vídeos.",
    capacidades: [
      "Gemini 2.0 Flash",
      "Visão Multimodal",
      "Prompt Engineering",
  ...
  },
  {
    ...
    descricao:
      "Gera ilustrações HD, banners promocionais de vendas e posts para redes sociais em segundos.",
    capacidades: [
      "Google Imagen 3 HD",
      "Fotos de Produtos",
      "Formatos 1:1 e 9:16",
  ...
  },
  {
    ...
    descricao:
      "Cria animações e vídeos curtos de 15s/30s prontos para publicação no Instagram Reels e TikTok.",
    capacidades: ["Google Veo Video AI", "Roteiros de Vendas", "Animação 4K", "Legendas Dinâmicas"],
    promptInicial:
      "Olá! Qual produto ou oferta você quer transformar em um vídeo publicitário incrível?",
  },
  {
    id: "agente-bi",
    ...
    descricao:
      "Analisa conversas, taxas de conversão de leads e relatórios executivos em tempo real.",
    capacidades: [
      "Gemini Thinking Pro",
    ...
    promptInicial:
      "Olá! Sou o Atlas Analytics. Solicite um relatório de vendas ou métricas de atendimento a qualquer momento.",
  },
];
...
export function AgentsPage() {
  ...
  const enviarMensagemPrompt = (promptText?: string) => {
    ...
    setTimeout(() => {
      ...
      if (
        agenteSelecionado.id === "agente-imagens" ||
        ...
        agenteSelecionado.id === "agente-videos" ||
      ...
      <div style={{ display: "grid", gridTemplateColumns: "320px 1fr", gap: 20 }}>
          ...
          {AGENTES.map((a) => (
            <div
              ...
              style={{
                ...
                background:
                  agenteSelecionado.id === a.id ? "rgba(109, 40, 217, 0.12)" : "var(--panel)",
                cursor: "pointer",
        ...
        >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div
                style={{
                  ...
                  height: 36,
                  borderRadius: 10,
                  background: agenteSelecionado.cor,
                  color: "#fff",
                  display: "grid",
                  placeItems: "center",
                  fontSize: 18,
            ...
            <div style={{ display: "flex", gap: 6 }}>
              {agenteSelecionado.capacidades.map((cap) => (
                <span
                  key={cap}
                  className="tag"
                  style={{ fontSize: 10, background: "var(--panel)" }}
                >
                  {cap}
                </span>
              ))}
          ...
          >
            {[
              {
                label: "🎨 Gerar Banner de Vendas",
                prompt: "Crie um banner promocional para o WhatsApp sobre nosso curso de IA.",
              },
              {
                label: "🎬 Criar Vídeo para Reels",
                prompt: "Gere um roteiro e vídeo animado de 15 segundos para mídias sociais.",
              },
              {
                label: "📝 Redigir Script Comercial",
                prompt:
                  "Escreva um script de atendimento matador para converter leads no WhatsApp.",
              },
              {
                label: "📊 Ver Métricas do Sistema",
                prompt: "Gere um relatório executivo de métricas de vendas e atendimento.",
              },
            ].map((card) => (
              <button
                key={card.label}
