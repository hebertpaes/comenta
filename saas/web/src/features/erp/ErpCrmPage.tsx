...
export function ErpCrmPage() {
  const [activeTab, setActiveTab] = useState<"crm" | "financial" | "stock" | "whatsapp_menu">(
    "whatsapp_menu"
  );
  ...
  const [deals, setDeals] = useState<Deal[]>([
    {
      id: "deal_1",
      title: "Treinamento Corporativo Pacote Office Pro",
    ...
    {
      id: "deal_4",
      title: "Curso Cibersegurança & LGPD",
  ...
  const handleOptionChange = (index: number, field: keyof MenuOption, value: string) => {
    const updated = menuConfig.options.map((opt, idx) =>
  ...
  const moveDealStage = (dealId: string, newStage: Deal["stage"]) => {
    setDeals((prev) =>
      prev.map((d) =>
        d.id === dealId
          ? { ...d, stage: newStage, probability: newStage === "fechado" ? 100 : 60 }
          : d
      )
    );
  };
    ...
    <div style={{ paddingBottom: 40 }}>
      ...
      >
        <div>
          ...
          <p className="muted" style={{ marginTop: -8, marginBottom: 0 }}>
            Crie e edite opções do menu do WhatsApp, gerencie propostas comerciais, lançamentos do
            ERP e produtos.
          </p>
        </div>
      </div>
      ...
      >
        <div className="card" style={{ padding: 18 }}>
          ...
          >
            R${" "}
            {(totalReceitas - totalDespesas).toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
          </div>
        </div>
      ...
      {activeTab === "whatsapp_menu" && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 420px", gap: 20 }}>
            ...
            >
              <div>
                <h3 style={{ margin: 0, fontSize: 16, fontWeight: 800 }}>
                  ⚙️ Editor do Menu Interativo do WhatsApp
                </h3>
                  ...
                  {menuConfig.options.map((opt, idx) => (
                    ...
                    >
                      ...
                      <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                        ...
                        >
                          <option value="courses_catalog">
                            🎓 Enviar Catálogo de 17 Cursos ABACS
                          </option>
                          <option value="store_products">🛍️ Enviar Catálogo de Produtos ERP</option>
                          <option value="financial_invoices">
                            🧾 Consultar Faturas / PIX (ERP)
                          </option>
          ...
          <div
            className="card"
            style={{ padding: 20, height: "fit-content", position: "sticky", top: 20 }}
          >
            <h3
              style={{
                margin: "0 0 10px 0",
            ...
            >
              ...
              <span className="tag" style={{ background: "#25D366", color: "#fff", fontSize: 10 }}>
                Ao Vivo
              </span>
            </h3>
      ...
      {activeTab === "crm" && (
        <div>
          ...
          >
            ...
            />
            <button type="submit" style={{ fontWeight: 700 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    {stageDeals.map((deal) => (
                      <div
                        key={deal.id}
                        className="card"
                        style={{ padding: 12, background: "var(--panel)" }}
                      >
                        ...
                        <div
                          style={{ fontSize: 14, fontWeight: 800, color: "#10b981", marginTop: 6 }}
                        >
        ...
        <div>
          ...
          <div className="card" style={{ padding: 0, overflow: "hidden" }}>
            ...
            >
              <thead>
                <tr
                  style={{ background: "var(--panel2)", borderBottom: "1px solid var(--border)" }}
                >
