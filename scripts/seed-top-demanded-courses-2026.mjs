...
const TOP_DEMANDED_COURSES = [
  {
    ...
    description:
      "Aprenda a criar comandos avançados no Google Gemini, ChatGPT e automações de IA para empresas.",
    emoji: "🤖",
    level: "intermediario",
    price: 149.0,
    lessons: [
  ...
  },
  {
    ...
    description:
      "Defesa cibernética, testes de invasão éticos, segurança de redes e adequação à LGPD.",
    emoji: "🛡️",
    level: "avancado",
    price: 199.0,
    lessons: [
  ...
  },
  {
    ...
    description:
      "Domine campanhas patrocinadas no Google Ads, Instagram, Facebook e TikTok Ads para gerar vendas diárias.",
    emoji: "📈",
    level: "intermediario",
    price: 149.0,
    lessons: [
  ...
  },
  {
    ...
    description:
      "Transforme dados brutos em dashboards visuais e inteligência de negócios para tomada de decisão.",
    emoji: "📊",
    level: "intermediario",
    price: 129.0,
    lessons: [
  ...
  },
  {
    ...
    description:
      "Cadeia de suprimentos, gestão de estoque, expedição rápida e estratégias de frete no e-commerce.",
    emoji: "🚚",
    level: "iniciante",
    price: 99.0,
    lessons: [
