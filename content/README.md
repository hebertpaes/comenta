...
| Flávia Moretti (prefeita de Várzea Grande) | cabelos lisos castanho-claros aloirados na altura do peito (em 25/09/2026, presos em rabo de cavalo), pele clara, sorriso largo, camisa social azul-clara | `MAHWPwnDBSs` (três quartos, com microfone, 25/09/2026), `MAHWP4_6AXk` (rindo, com microfone, 25/09/2026); segunda opção: `MAHWIE_abVw` e `MAHWIMIJ4SM` (19/09/2026, cabelo solto) | Galeria oficial da Prefeitura de Várzea Grande (40 anos do 2º Batalhão de Bombeiros, 25/09/2026, `varzeagrande.mt.gov.br/conteudo/25553`), Foto: Andre Luis/Secom-VG. Só referência de desenho. A antiga (`MAHWEXj-FW4`, TSE 2024) está desatualizada. |
| Otaviano Pivetta (governador) | careca, óculos redondos de armação escura grossa, sorriso largo, camisa polo azul-marinho | `MAHWH0J-3js` (foto oficial do registro de candidatura, TSE, ago/2026) | TSE/Divulgação. A antiga (`MAHWEbbOGVM`) fica como segunda opção. Em 25/09/2026 a Secom-MT não tinha foto mais nova (sem notícias do governador desde 03/07, período eleitoral). |
...
| Ilde Taques (vereador de Cuiabá, Podemos) | sem referência cadastrada | nenhuma | 25/09/2026: o portal da Câmara Municipal de Cuiabá recusa o acesso daqui e o DivulgaCand (TSE 2024) é bloqueado fora do Brasil; sem foto oficial, a charge "Consenso à la Taques" usou vereador genérico. Se conseguir a foto oficial da Câmara, suba ao Canva e registre aqui. |
