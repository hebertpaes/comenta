...
# "voz": {"motor": "kokoro", "narrador": "pm_santa:0.7,am_onyx:0.3", "tratamento": "suave"}
# (voz do Argos: mistura de vozes; am_onyx dá o grave sem baixar o tom).
set -euo pipefail
...
for v in pm_santa pm_alex pf_dora am_onyx; do
